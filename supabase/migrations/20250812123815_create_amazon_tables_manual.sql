-- Create Amazon UAE integration tables manually
...
CREATE TABLE IF NOT EXISTS amazon_orders (
    ...
    status VARCHAR(20) DEFAULT 'pending' CHECK (status IN ('pending', 'payment_pending', 'processing', 'shipped', 'delivered', 'successful', 'cancelled')),
